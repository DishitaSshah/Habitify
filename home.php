                    ...
                    <div class="modal-content" style="background-color: rgb(60, 60, 60)">
                        ...
                        <div class="modal-body">
                            <form action="./endpoint/update-tracker.php" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="updatePray" class="col-sm-6 col-form-label">Meditation</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label for="updateVitamins" class="col-sm-6 col-form-label">Drink Water:</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label for="updateLaundry" class="col-sm-6 col-form-label">Spent time in Nature:</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label for="updateAlcohol" class="col-sm-6 col-form-label">Spent Time with Loved Ones:</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label for="updateMeat" class="col-sm-6 col-form-label">:</label>
                                    <div class="col-sm-6">
                ...
                <table class="table habit-table">
                    <thead class="thead-dark">
                        <tr>    
                            ...
                            <th scope="col">Read a Book</th>
                            <th scope="col">Drink Water</th>
                            <th scope="col">Spent time in Nature</th>
                            <th scope="col">Spending Time with Loved Ones</th>
